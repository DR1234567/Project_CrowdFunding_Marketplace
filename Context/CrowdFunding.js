...
//INTERNAL IMPORT
import { CrowdFundingABI, CrowdFundingAAddress } from "./contants";
import { transformSync } from "next/dist/build/swc";

//---FETCHING SMART CONTRACT
const fetchContract = (signerOrProvider) =>
 new ethers.Contract(CrowdFundingAAddress, CrowdFundingABI, signerOrProvider);
 ...
 export const CrowdFundingProvider = ({ children }) => {
        ...
        const createCampaign =async (campaign) => {
         const { title, descriptions, amount, deadline } = campaign;
         ...
         try{
            const transaction = await congtarct.createCampaign(
             ...
             const userData = filteredCampaigns.map((campaign, i) => ({
              ...
              const connectWallet = async () => {
                try{
                    ...
                    console.log("Error while connectiong to wallet");
                }
              };
